...
function Input({ className, error, type='text', errorMessage, ...props }: InputProps, ref: LegacyRef<HTMLInputElement> | undefined) {
  ...
  return (
    <div className="flex w-full flex-col">
      <input ref={ref} className={inputClassName} {...props} type={type}/>
